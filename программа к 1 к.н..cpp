...
class rabotnik
{
	...
	public:
		...
		//дружественные функции дл€ перегруженных операторов
...
{
	--num_rab;
	std::cout<< "ќбъект удален" << std::endl;
...
istream & operator >> (istream & is, rabotnik & rab) 
{
	...
	std::cin >> rab.opyt;
	std::cout<< "¬ведите его зарплату: ";
	std::cin >> rab.zp;
	std::cout<< "¬ведите количество прогулов: ";
	std::cin >> rab.proguly;
	return is;
}
...
int main() 
{
   ...
   cout << "¬ведите данные о сотрудниках"<< endl;
